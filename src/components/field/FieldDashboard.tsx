...
export const FieldDashboard: React.FC<FieldDashboardProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* JOINT DIRECTOR DIVISIONAL SURVEILLANCE PANEL — moved below the JD
          Office Direct Demands section above, per request: JD's own pending
          demands should be visible before the mandal's ITI list/data. */}
      {isJD && (
